...
public:
    MultipleChoiceQuestion(enum type type, std::string questionID, std::string prompt, int time, double score, std::vector<std::string> options, std::string correctAnswer);
